...
const Opiskelija_1 = require("../src/models/Opiskelija");
describe('Opiskelija', () => {
    it('pitäisi luoda uusi opiskelija oikeilla tiedoilla', () => {
        const opiskelija = new Opiskelija_1.Opiskelija('1', 'Matti Meikäläinen', new Date(1990, 0, 1), 'Tietojenkäsittelytiede');
